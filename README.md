...
- **tmux.conf** - Cross-platform config (WSL2, macOS, native Linux) with system clipboard integration, working scroll, drag-to-copy, right-click paste, double/triple-click selection, and a cheat sheet status bar
